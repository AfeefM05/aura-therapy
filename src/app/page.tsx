...
export default function Home() {
  ...
  const leavesParticlesOptions: RecursivePartial<IOptions> = {
    particles: {
      number: {
        value: 15,
        density: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="h-screen flex items-center justify-center pt-4">
        <div className="w-full max-w-6xl flex items-center justify-between gap-16 px-8">
          {/* Buddha Section */}
          <div className="w-1/2">
      ...
      {/* Feature Components */}
      <div className="w-full max-w-6xl mx-auto space-y-40 py-40">
        <motion.div
          initial={{ opacity: 0, x: -100 }}
      ...
      {/* Team Section */}
      <div className="w-full max-w-6xl mx-auto py-40 px-8 relative z-20">
        <motion.div
        ...
        >
          <h2 className="text-4xl font-serif text-white mb-4">Our Team</h2>
          <p className="text-gray-300 text-lg">
            Meet the minds behind Aura Therapy
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-300">LLM Architect</p>
          </motion.div>
        </div>
      </div>
